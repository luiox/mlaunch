...
## 批次 A：搜索模式修复（进行中，上下文见文末）

- [ ] **A1 修复搜索模式布局**：进入搜索模式后 searchBar(34px 灰条) 以叠加方式画在 body 顶部，
